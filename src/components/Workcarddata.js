...
const ProjectCardData=[
    ...
    },
    {
        ...
        text:'Developed a website where users can check my complete profile. User has to SignUp into the site to view the profile if he/she is accessing for the first time. Else they can view it by SignIn info.User can send Mails through GMAIL by entering their mailId and message. Users can send Messag directly on Whatsapp. Employers can download my Resume through site directly.',
        view: '',
        source:''
    },
]
